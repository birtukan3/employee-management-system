...
//    	String E6 = SoftSkills.getValue().toString();
        ...
        PreparedStatement p = cc.prepareStatement(query0);
         ...
         e_id = r.getString(1);
	    	    ...
	    	    String q = "UPDATE  employee_performance SET SinceritySelf='"+E1+"',ReliabilitySelf='"+E2+"',LeadSelf='"+E3+"',TeamSelf='"+E4+"',IntegritySelf='"+E5+"',SoftSkillsSelf='"+E6+"' WHERE Eid='"+e_id+"' ";
