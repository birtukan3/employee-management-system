...
public class HR_Company_Reports_Controller implements Initializable{
    ...
    void onAction_NewButton(ActionEvent event) throws IOException {
         System.out.println(getClass().getResource("HR_Company_Reports.fxml"));
    ...
    void onAction_DisplayButton(ActionEvent event) throws IOException {
        System.out.println(getClass().getResource("HR_Cmpany_Reports_Display.fxml"));
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		int a1=0,a2=0,a3=0,a4=0,a5=0,a6=0;
	   	 ...
	   	 try{		   	
		   		Conn con = new Conn();
	            String str = "SELECT Avg(SincerityHR) , AVG(ReliabilityHR), AVG(LeadHR), AVG(TeamHR),AVG(IntegrityHR),AVG(SoftSkillsHR) FROM employee_performance;";
